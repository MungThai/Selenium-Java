...
import io.github.mung.reports.ExtentTestManager;
import io.github.mung.enums.FailureHandling;
...
public class CommonPageUtils {
    ...
    public static WebElement highLightElement(By by) {
        ...
        if (DriverManager.getDriver() instanceof JavascriptExecutor) {
            ((JavascriptExecutor) DriverManager.getDriver()).executeScript("arguments[0].style.border='2px solid red'", waitForElementVisible(by));
            //sleep(1);
