...
public final class GlobalVars {
    ...
    public static final String EXCEL_HRM_LOGIN = PropertiesHelpers.getValue("EXCEL_HRM_LOGIN");
    ...
    public static final String URL_HRM = PropertiesHelpers.getValue("URM_HRM");
